...
Examples:
  ...
  python 04_train_qlora.py --data data/clean.jsonl --output out_lora/ \\
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Validation data JSONL file (optional)"
    )
...
def setup_trainer(
    ...
    training_args = TrainingArguments(
        ...
        bf16=(lambda: (__import__("torch").cuda.is_available() and getattr(__import__("torch").cuda, "is_bf16_supported", lambda: False)()))(),
