...
"""
    ...
    # SECURITY: Filter environment variables to prevent leaking sensitive keys.
    # Excludes keys containing 'KEY', 'TOKEN', 'SECRET', or 'PASS'.
    safe_env = {
        k: v for k, v in os.environ.items()
        if not any(pattern in k.upper() for pattern in ("KEY", "TOKEN", "SECRET", "PASS"))
    }
