...
def test_python_code(code: str, temp_dir: str, execution_timeout: int = 5) -> Tuple[bool, str, str]:
    ...
    # SECURITY: Indent the user code to prevent SyntaxError in the wrapper.
...
"""
    ...
    try:
        # SECURITY: Use a restricted environment to prevent untrusted code
        # from accessing host secrets (e.g. OPENAI_API_KEY).
        restricted_env = {
