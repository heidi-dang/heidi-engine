...
def test_python_code(code: str, temp_dir: str, execution_timeout: int = 5) -> Tuple[bool, str, str]:
    ...
    # SECURITY: Use textwrap.indent to ensure code is properly nested in try block
...
"""
    ...
    try:
        # SECURITY: Do NOT pass full os.environ to untrusted code.
        # This prevents leaking sensitive keys like OPENAI_API_KEY.
        safe_env = {
            "PYTHONPATH": temp_dir,
