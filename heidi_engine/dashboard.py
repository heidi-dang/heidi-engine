...
# BOLT OPTIMIZATION: Use telemetry.AUTOTRAIN_DIR for consistency
...
def load_state(run_id: str) -> Dict[str, Any]:
    ...
    RETURNS:
        State dictionary
    """
    # BOLT OPTIMIZATION: Use telemetry.get_state for thread-safe caching.
...
def poll_gpu_info() -> Dict[str, Any]:
    ...
    HOW IT WORKS:
        - Calls telemetry.get_gpu_summary which has internal caching
    ...
    """
    # BOLT OPTIMIZATION: Use telemetry.get_gpu_summary for cached results.
