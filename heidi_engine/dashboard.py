...
def get_run_dir(run_id: str) -> Path:
    ...
    # Handle cases where .name is empty (e.g. ".") or traversal markers like ".."
    if not safe_run_id or safe_run_id in (".", ".."):
        # Fallback to a safe but likely non-existent run_id to fail safely
        # rather than returning the base 'runs/' directory.
        safe_run_id = "invalid_run_id_traversal_attempted"
