...
def get_run_dir(run_id: Optional[str] = None) -> Path:
    ...
    SECURITY:
        ...
        - Uses .name to ensure run_id stays within runs/
    ...
    # Path(run_id).name extracts only the filename/last part of path.
    # We fall back to get_run_id() if name is empty (e.g. ".", "..").
