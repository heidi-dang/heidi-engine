...
# BOLT OPTIMIZATION: Cache for pricing config to avoid redundant I/O
...
def load_pricing_config() -> Dict[str, Dict[str, float]]:
    ...
    BOLT OPTIMIZATION:
        Uses a thread-safe module-level cache with 5s TTL to avoid
        redundant disk I/O and JSON parsing on every cost estimation.
