...
def sanitize_run_id(run_id: str) -> str:
    ...
    HOW IT WORKS:
        ...
        - Replaces with "invalid_run_id" if potentially dangerous

    SECURITY:
        - Prevents directory traversal via malicious run_id
    """
    if not run_id:
    ...
    # Check for empty name or parent directory reference
...
def get_run_id() -> str:
    ...
    HOW IT WORKS:
        - Uses RUN_ID env var if set (and sanitizes it)
