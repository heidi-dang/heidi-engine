...
# BOLT OPTIMIZATION: Module-level cache for pricing config
...
def load_pricing_config() -> Dict[str, Dict[str, float]]:
    ...
    BOLT OPTIMIZATION:
        Thread-safe caching with 5.0s TTL to avoid redundant disk I/O and
        JSON parsing during high-frequency token tracking.
    ...
    with _lock:
        ...
        try:
            ...
            with open(events_file, "a") as f:
                # BOLT OPTIMIZATION: Use writelines with generator to reduce Python-to-C overhead.
