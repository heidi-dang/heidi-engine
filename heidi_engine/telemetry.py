...
def get_run_dir(run_id: Optional[str] = None) -> Path:
    ...
    SECURITY:
        ...
        - Uses Path(run_id).name to ensure only the last component is used.
    ...
    # Path(run_id).name extracts only the last component, preventing absolute
    # paths or '../' navigation from escaping the runs directory.
